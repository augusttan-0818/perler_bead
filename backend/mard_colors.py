# MARD 221 Perler Bead Color Palette
# Each color has: name, hex code, RGB tuple
...
def get_color_palette():
    """Return palette as list of (name, rgb) tuples."""
    return [(name, hex_to_rgb(hex_val)) for name, hex_val in MARD_221_COLORS.items()]

# Pre-compute RGB values for faster lookup
MARD_221_RGB = {name: hex_to_rgb(hex_val) for name, hex_val in MARD_221_COLORS.items()}
